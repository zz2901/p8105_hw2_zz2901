...
>>>>>>> 1265d717c7569b008a82941088fad4b064c57bf0
...
* Then merging `pols_snp_merge` and `unemployment` by variables `year` and `month`, the merged data set `pols_snp_unemployment` has ``r nrow(pols_snp_unemployment)`` observations and ``r ncol(pols_snp_unemployment)`` variables.
